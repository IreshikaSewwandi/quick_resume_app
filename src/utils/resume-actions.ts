...
export const saveResume = (resumeData: ResumeData): boolean => {
  try {
...
export const previewResume = (): boolean => {
  try {
    ...
    if (!previewWindow) {
      console.error("Please allow pop-ups to preview your resume")
      return false
    }
...
export const downloadAsPDF = (): boolean => {
  try {
    // Get the resume content
    const resumeContent = document.getElementById("resume-preview-content")
    ...
    if (!printWindow) {
      console.error("Please allow pop-ups to download your resume")
      return false
    }
